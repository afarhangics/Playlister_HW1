...
export default class PlaylisterController {
    ...
    */
    ...
    {
        // ENABLE TOOLBAR
        this.model.setSongIndex(index);
    }
    removeSong(){
        // GET CURRENT SONG
        const currentSongPayload = this.model.getCurrentSong();
        // DELETE THE SONG, THIS IS NOT UNDOABLE
        this.model.removeSongTransaction(currentSongPayload);
    }
    ...
    */
    initEditToolbarHandlers() {
        ...
        document.getElementById("add-song-button").onmousedown = (event) => {
            // ENABLE TOOLBARS
            this.model.addNewSongTransaction();
       }
    ...
    */
    initModalHandlers() {
        ...
        let editSondConfirmButton = document.getElementById("edit-song-confirm-button");
        editSondConfirmButton.onclick = (event) => {
            
           const title = document.getElementById("song-title").value;
           const artist = document.getElementById("song-artist").value;
           const youTubeId = document.getElementById("song-you-tube-id").value;
           ...
           // GET CURRENT SONG VALUES
            ...
            this.model.editSongTransaction(currentSongPayload, updatedSong);
        ...
        // RESPOND TO THE USER CONFIRMING TO DELETE SONG FROM A PLAYLIST
    ...
    */
    registerListSelectHandlers(id) {
        ...
        document.getElementById("list-card-text-" + id).ondblclick = (event) => {
            ...
            textInput.classList.add("listinput");
